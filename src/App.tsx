  ...
  return (
    <Routes>
      ...
      <Route element={<AppLayout />}>
        ...
        <Route path="/referral" element={<Suspense fallback={<PageLoader />}><Referral /></Suspense>} />
      </Route>

      <Route path="/become-tutor" element={<Suspense fallback={<PageLoader />}><TutorOnboarding /></Suspense>} />
